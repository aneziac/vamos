        ...
        <form on:submit={handleSubmit} enctype="multipart/form-data">
            ...
            <div class="flex justify-center">
                <button 
                    ...
                    class="text-white font-bold py-2 px-6 rounded-full shadow-lg transition-all duration-300 ease-in-out hover:scale-105"
                >
                    Submit
                </button>
            </div> 
...
>>>>>>> 5882acd90b0db36b2c2126aa3d5aaddb2df240db
